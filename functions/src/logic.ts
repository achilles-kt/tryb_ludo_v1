...
const SAFE_INDICES = new Set<number>([
    0, 8, 13, 21, 26, 34, 39, 47,
]);

const FINAL_HOME_INDEX = 57;
...
function areTeammates(uid1: string, uid2: string, game: any): boolean {
...
function getTeammateUid(uid: string, game: any): string | null {
